...
void i2c_init(char i2c,unsigned short speed_mode)
{
	...
	if(i2c==1)
	{
		...
		// Pin enable
		init_GP(PB,6,OUT_50MHZ,OUT_AF_OPEN_DRAIN);
		init_GP(PB,7,OUT_50MHZ,OUT_AF_OPEN_DRAIN);
		I2C1->CR1 |= 0x8000;
		I2C1->CR1 &= ~0x8000;
		I2C1->CR2 =0x8;
		I2C1->CCR = speed_mode;
	...
	else if(i2c==2)
	{
		...
		// Pin enable
		init_GP(PB,10,OUT_50MHZ,OUT_AF_OPEN_DRAIN);
		init_GP(PB,11,OUT_50MHZ,OUT_AF_OPEN_DRAIN);
		I2C2->CR1 |= 0x8000;
		I2C2->CR1 &= ~0x8000;
		I2C2->CR2 =0x8;
		I2C2->CCR = speed_mode;
